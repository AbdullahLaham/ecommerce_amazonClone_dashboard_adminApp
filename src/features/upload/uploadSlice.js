...
export const uploadImage = createAsyncThunk('image/upload-images', async (data,thunkAPI) => {
    try {
 ...
 export const deleteImage = createAsyncThunk('image/delete-images', async (id,thunkAPI) => {
    try {
